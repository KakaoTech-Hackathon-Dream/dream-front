...
import 'package:hackathon/components/turn_page_animation.dart';
...
class TurnPageController extends ChangeNotifier {
  ...
  // TurnAnimationController 초기화 메소드 추가
  void initAnimation(TickerProvider vsync, int itemCount) {
